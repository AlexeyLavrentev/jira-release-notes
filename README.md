...
- **Редактор с live preview** — правка текста заметки каждой задачи, с мгновенным предпросмотром
  ...
  закрытием вкладки.
- **Группировка** — по типу задачи / компоненту / эпику / плоский список. Задача с несколькими
  компонентами попадает ровно в одну группу — последнего по алфавиту компонента.
